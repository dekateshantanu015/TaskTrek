"use strict";
(self["webpackChunktasktrek"] = self["webpackChunktasktrek"] || []).push([[792],{
...
const editProjectEvent = (e) => {
  ...
  e.preventDefault();
  editProject(
    e.currentTarget.currentProject,
    titleInput.value,
    descInput.value
  );
  modal.classList.add("display-none");
...
;// CONCATENATED MODULE: ./src/modules/create-dom-elements.js
...
;// CONCATENATED MODULE: ./src/modules/build-pages.js
...
/******/ var __webpack_exports__ = (__webpack_exec__(160));
/******/ }
]);